...
function AlertDialogContent({
  ...
  // Always generate a unique ID for this alert dialog
  const generatedId = React.useId();
  const fallbackDescriptionId = `alert-dialog-description-${generatedId}`;
      ...
      >
        ...
        {needsFallbackDescription && (
          <AlertDialogDescription id={fallbackDescriptionId} className="sr-only">
            Alert dialog with important information requiring user response
